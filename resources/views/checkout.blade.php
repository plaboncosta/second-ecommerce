...
<div class="container">
	...
	<div class="checkout-section">
		...
		<div>
			@if(!Auth::user())
				<span>Please click here to <a style="color: blue;" href="{{ route('login') }}">login</a></span>
			@endif
				...
				<div class="half-form">
					...
					<div class="mt-32">
						...
						{{-- <form method="post" id="paypal-payment-form" action="#"> --}}
							<input type="hidden" name="_token" value="gYz8x2huqGZL89NHjCaTZx6HwQhiCFGwh8OxLZa9">                            <section>
					...
					<div class="checkout-table-row">
						<div class="checkout-table-row-left">
							...
							<div class="alert alert-danger">
								<span>You have no item in checkout!</span>
							</div>
							@endif
							</div> <!-- end checkout-table -->
							...
							<div class="checkout-totals">
								<div class="checkout-totals-left">
									...
									<form action="{{ route('coupon.destroy') }}" method="post" style="display: inline;">
										@csrf
										@method('delete')
										<button style="background-color: transparent; font-size: 14px;" type="submit">Remove</button>
									</form>
									<br>
									@endif
									<hr>
