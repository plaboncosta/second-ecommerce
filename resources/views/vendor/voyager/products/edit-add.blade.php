                        ...
                        <div class="panel-body">
                            ...
                            <ul class="category-section">
                                @foreach($categories as $category)
                                    <li>
                                        <label for="{{ $category->slug }}"><input type="checkbox" id="{{ $category->slug }}" value="{{ $category->id }}" name="category[]"
                                                @foreach($dataTypeContent->categories as $productCategory)
                                                    {{ $productCategory->id == $category->id ? 'checked' : '' }}
                                                @endforeach
                                            ><span class="category-name">{{ $category->name }}</span></label>
                                    </li>
                                @endforeach
                            </ul>
